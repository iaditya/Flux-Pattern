...
var ForumAnswers = /*#__PURE__*/function (_React$Component) {
  _inherits(ForumAnswers, _React$Component);

  var _super = _createSuper(ForumAnswers);
  ...
  _createClass(ForumAnswers, [{
    key: "_onMarkCorrect",
    value: function _onMarkCorrect(answer) {
      var that = this;
      console.log(answer); //dispatch now, because an event has occured.
